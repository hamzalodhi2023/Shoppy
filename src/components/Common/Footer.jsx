        ...
        <footer className='border-t py-12'>
            <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
                <div>
                    ...
                    {/* Newsletter form */}
                    <form className='flex'>
                        <input type="text" placeholder='Enter your email' className='p-3 w-full text-sm border-t border-l border-gray-300 rounded-l-md border-b focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all' required />
